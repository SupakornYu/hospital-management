<?php
	...
	$start_rest_search = isset($_POST['START_REST']) ? $_POST['START_REST'] : '01/01/0001';
	$start_rest_search2 = isset($_POST['START_REST']) ? $_POST['START_REST'] : '01/01/0001';
	...
	$s = oci_parse($c, "select * 
						from(SELECT rownum r,RECU_ID,ID_NO,START_REST,END_REST
							 from ( select j.* from look_after j 
									...
									and START_REST >= to_date('$start_rest_search' ,'MM/DD/YYYY')
